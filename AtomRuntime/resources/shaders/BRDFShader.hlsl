#include "include/BRDFResources.hlsli"
...
static BRDFResources g_BRDFResources = CreateBRDFResources();

[numthreads(32, 32, 1)]
void CSMain(uint2 ThreadID : SV_DispatchThreadID)
{
	float outputWidth, outputHeight;
	g_BRDFResources.BRDFTexture.GetDimensions(outputWidth, outputHeight);
	...
	g_BRDFResources.BRDFTexture[ThreadID] = float2(DFG1, DFG2) * InvNumSamples;
}