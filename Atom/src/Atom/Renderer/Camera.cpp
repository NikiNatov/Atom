...
namespace Atom
{
    ...
    void OrthographicCamera::RecalculateProjection()
    {
        ...
        m_ProjectionMatrix = glm::transpose(glm::ortho(left, right, bottom, top, m_Near, m_Far));
    }
    ...
    void SceneCamera::RecalculateProjection()
    {
        ...
        else
        {
            ...
            m_ProjectionMatrix = glm::transpose(glm::ortho(left, right, bottom, top, m_OrthographicNear, m_OrthographicFar));
        }
    }
}
