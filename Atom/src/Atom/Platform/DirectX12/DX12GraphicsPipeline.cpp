...
namespace Atom
{
        ...
        : m_Description(description)
    {
        ...
        ///                            Create PSO                           //
        //////////////////////////////////////////////////////////////////////
        DX12Shader* shader = m_Description.Shader->As<DX12Shader>();
        DX12Device* device = Renderer::GetDevice().As<DX12Device>();
    ...
    // -----------------------------------------------------------------------------------------------------------------------------
    const PipelineLayout& DX12GraphicsPipeline::GetLayout() const
    {
    ...
    // -----------------------------------------------------------------------------------------------------------------------------
    Topology DX12GraphicsPipeline::GetTopology() const
    {
        return m_Description.Topology;
    }

    // -----------------------------------------------------------------------------------------------------------------------------
    bool DX12GraphicsPipeline::IsDepthTestingEnabled() const
    {
        return m_Description.EnableDepthTest;
    }

    // -----------------------------------------------------------------------------------------------------------------------------
    bool DX12GraphicsPipeline::IsBlendingEnabled() const
    {
        return m_Description.EnableBlend;
    }

    // -----------------------------------------------------------------------------------------------------------------------------
    bool DX12GraphicsPipeline::IsWireframe() const
    {
        return m_Description.Wireframe;
    }

    // -----------------------------------------------------------------------------------------------------------------------------
    bool DX12GraphicsPipeline::IsBackfaceCullingEnabled() const
    {
