...
namespace SIGCompiler
{
    static std::vector<std::pair<SIGTokenType, std::regex>> s_Rules = {
        ...
        { SIGTokenType::ShaderInputLayout,      std::regex("ShaderInputLayout") },
        { SIGTokenType::BindPoint,              std::regex("BindPoint") },
        { SIGTokenType::StaticSampler,          std::regex("StaticSampler") },
        ...
        { SIGTokenType::BindToAnotation,        std::regex("BindTo=") },
        { SIGTokenType::SamplerFilter,          std::regex("SamplerFilter::Linear|SamplerFilter::Nearest|SamplerFilter::Anisotropic") },
        { SIGTokenType::SamplerWrap,            std::regex("SamplerWrap::Clamp|SamplerWrap::Repeat") },
        ...
        { SIGTokenType::Colon,                  std::regex(":") },
        { SIGTokenType::Equals,                 std::regex("=") },
        { SIGTokenType::Comma,                  std::regex(",") },
    };
